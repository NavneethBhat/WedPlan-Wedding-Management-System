          ...
          <?php
            if (isset($_SESSION['uname'])) {
             ...
             $run=mysqli_query($con,$sql);
              ...
              $row=mysqli_fetch_array($run);
              $price9=$row['price'];
              $sql="SELECT * FROM lighting WHERE ldid='$ldid' ";
              $run=mysqli_query($con,$sql);
              $row=mysqli_fetch_array($run);
              $price7=$row['price'];
              $sql="SELECT * FROM transportation WHERE tpid='$tpid' ";
              $run=mysqli_query($con,$sql);
              $row=mysqli_fetch_array($run);
              $price8=$row['price'];
...
<div class="container">
  <div class="card">
    <div class="card-header bg-info">
      ...
      <h4 class='text-center'>Trasportation Details</h4><hr>
      <div class='row'>
        <div class='col-md-6'>
      ...
      <h4 class='text-center'>Lighting Details</h4><hr>
      <div class='row'>
        <div class='col-md-6'>
          <h5>lighting :</h5>
          <h5>Price :</h5>
  ...
  <section id="service" class="services-mf route">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
            <a href="lighting.php">
          <div class="service-box" style="background-image:url(img/ld.jpg); background-size: cover;">
            <div class="service-ico">
            </div>
            <div class="service-content ">
              <h2 class="s-title text-white"> <b>Lighting Design</b></h2>
              <p class="s-description text-center text-white"><b>
              </b>
              </p>
            </div>
        ...
        <div class="col-md-4">
          ...
          <div class="service-box" style="background-image:url(img/vc.jpeg); background-size: cover;">
            <div class="service-ico">
            </div>
            <div class="service-content ">
              <h2 class="s-title text-white"> <b>Trasportation</b></h2>
              <p class="s-description text-center text-white"><b>
              </b>
              </p>
            </div>
        ...
        <div class="col-md-4">
          <a href="makeup.php">
          <div class="service-box" style="background-image:url(img/mk.jpeg); background-size: cover;">
            <div class="service-ico">
            </div>
            <div class="service-content ">
              <h2 class="s-title text-white"> <b>Makeup</b></h2>
              <p class="s-description text-center text-white"><b>
              </p>
            </div>
          </div></a>
  ...
  <div class="section-counter paralax-mf bg-image" style="background-image: url(marriage.jpg)">
 ...
 <!-- <div class="testimonials paralax-mf bg-image" style="background-image: url(marriage.jpg)">
    <div class="overlay-mf"></div>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                <img src="marriage-quote1.jpg" alt="" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;>
