...
<body id="page-top">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">-->
          ...
          <!--<h1 class="intro-title mb-4">MITE Wedding Organizer</h1>-->
  ...
  <!--/ Intro Skew End /-->
<div id="#das">
 <h2 class="text-center">Makeup Details</h2>
  <br>
   <div class="container">
     <div class="card">
                ...
                $desc=$row['descr'];
                  ...
                  echo " <div class='row'>
                        ...
                        <div class='col-md-3'><h5>$desc</h5></div>
                         <div class='col-md-3'><a href='' class='btn btn-outline-info add9' rname='$name' rid='$mkid'>ADD</a></div>
                         </div><br>";
               
              }
              echo '<a href="transportation.php">
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                <img src="marriage-photo1.jpeg" alt="" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;>
